...
class RecipeIngredientQuantitiesControllerTest < ActionController::TestCase
  ...
  test "should create recipe_ingredient_quantity" do
    assert_difference('RecipeIngredientQuantity.count') do
      post :create, recipe_ingredient_quantity: { quantity_id: @recipe_ingredient_quantity.quantity_id, recipe_ingredient_id: @recipe_ingredient_quantity.recipe_ingredient_id }
    end
  ...
  test "should update recipe_ingredient_quantity" do
    put :update, id: @recipe_ingredient_quantity, recipe_ingredient_quantity: { quantity_id: @recipe_ingredient_quantity.quantity_id, recipe_ingredient_id: @recipe_ingredient_quantity.recipe_ingredient_id }
    assert_redirected_to recipe_ingredient_quantity_path(assigns(:recipe_ingredient_quantity))
  end
